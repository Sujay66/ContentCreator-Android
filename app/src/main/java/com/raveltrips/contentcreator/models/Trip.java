...
public class Trip {
	...
	private List<String> paidActivityIds;
	...
	public Trip copyFromTrip(Trip trip){
		...
		if(trip.getPaidActivityIds()!=null)this.paidActivityIds = trip.getPaidActivityIds();
	...
	public Trip copyFromCompleteTrip(CompleteTrip trip){
	...
	/**
	 * @return the paidActivityIds
	 */
	public List<String> getPaidActivityIds() {
		return paidActivityIds;
	}


	/**
	 * @param paidActivityIds the paidActivityIds to set
	 */
	public void setPaidActivityIds(List<String> paidActivityIds) {
		this.paidActivityIds = paidActivityIds;
	}
