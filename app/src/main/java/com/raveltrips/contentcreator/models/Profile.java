...
public class Profile {
	...
	public Profile copyFromProfile(Profile updatedProfile){
		...
		if(!IsEmpty(updatedProfile.getCreatorID()))this.setCreatorID(updatedProfile.getCreatorID());
		if(!IsEmpty(updatedProfile.getYouTubeURL()))this.setYouTubeURL(updatedProfile.getYouTubeURL());
		if(!IsEmpty(updatedProfile.getQuickBio()))this.setQuickBio(updatedProfile.getQuickBio());
	...
	public void setQuickBio(String quickBio) {
		this.QuickBio = quickBio;
	}
}
