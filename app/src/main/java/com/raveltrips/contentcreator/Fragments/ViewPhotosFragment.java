...
import com.raveltrips.contentcreator.Adapters.ViewPhotosAdapter;
 ...
 * {@link ViewPhotosFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link ViewPhotosFragment#newInstance} factory method to
...
public class ViewPhotosFragment extends Fragment {
    ...
    public static ViewPhotosFragment newInstance() {
    ...
    public static ViewPhotosFragment newInstance(Object param1) {
        ViewPhotosFragment fragment = new ViewPhotosFragment();
        Bundle args = new Bundle();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(mParam1 instanceof Pindrop){
            urls = ((Pindrop) mParam1).getImageUrls();
        }else if(mParam1 instanceof Restaurants) {
            urls = ((Restaurants) mParam1).getImageUrls();
        } else{
                urls = ((PaidActivities) mParam1).getImageUrls();
            }
        ...
        adapter = new ViewPhotosAdapter(getContext(),urls);
